...
#
# Returns: entero con el número de etapas donde el triplete es positivo
...
network_triplets_for_graphs <- dt_graph_base[, .(
  ...
  diagnostics = list(NULL)   # sin inyección. tryCatch Returns rep(0L,7)
)]
